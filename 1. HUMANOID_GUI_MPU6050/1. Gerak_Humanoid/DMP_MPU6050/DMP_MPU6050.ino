...
// SoftwareSerial Serial1(0, 1); // RX on pin 10, TX on pin 11
...
void setup() {
  ...
  // Serial1.begin(115200);  //for uart rx tx communication
  while (!Serial);
  ...
  //*......>......-1322.00000,	-487.00000,	4470.00000,	278.00000,	2930.00000,	53.00000
  //...-1310.00000,	-575.00000,	4388.00000,	279.00000,	2929.00000,	55.00000

  mpu.setXGyroOffset(-1310);
  mpu.setYGyroOffset(-575);
  mpu.setZGyroOffset(4388);
  mpu.setXAccelOffset(279);
  mpu.setYAccelOffset(2930);
